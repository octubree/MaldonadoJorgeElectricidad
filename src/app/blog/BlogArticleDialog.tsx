 ...
 * with the full article body. The parent supplies a single child element
 * (typically a <button>); shadcn's `DialogTrigger asChild` handles the
 * click → open wiring via Radix Slot — no cloneElement needed.
 */
