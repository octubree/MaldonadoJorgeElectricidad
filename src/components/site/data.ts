...
export const BLOG_POSTS: BlogPost[] = [
  {
    "id": "diferencial-auto-electrico-uruguay",
    "title": "¿Qué diferencial preciso para cargar mi auto eléctrico en Uruguay?",
    "date": "21/07/2026",
    "excerpt": "Guía técnica sobre la elección del interruptor diferencial (Tipo A o Tipo B) para instalar un cargador de vehículo eléctrico (Wallbox) de forma segura.",
    "body": [
      ...
      "<img src=\"/images/blog/diferencial-ev-diagrama.jpg\" alt=\"Esquema de Seguridad: Cargador de Auto Eléctrico y Diferencial Tipo B/A\" style=\"border-radius:12px; margin:20px 0; width:100%; max-height:450px; object-fit:cover;\">",
      "---",
      "## El problema: Por qué el diferencial común de casa no alcanza",
      ...
      "---",
      "## Los tipos de diferenciales en el mercado (de un vistazo)",
      ...
      "* **[Tipo AC](/blog/post/disyuntor-diferencial-tipo-ac/):** El estándar residencial básico, optimizado exclusivamente para corrientes alternas sinusoidales puras.\n* **[Tipo A](/blog/post/disyuntor-diferencial-tipo-a/):** Diseñado para detectar tanto corrientes alternas como corrientes pulsantes con componentes continuas.\n* **[Tipo B](/blog/post/disyuntor-diferencial-tipo-b/):** La protección más completa, capaz de detectar fugas en corriente alterna, corrientes pulsantes y **corriente continua pura ($DC$)**.",
      "---",
      "## ¿Cuál es el diferencial que exige la carga de un auto eléctrico?",
      ...
      "### Opción 1: Un [diferencial Tipo B](/blog/post/disyuntor-diferencial-tipo-b/) (La solución \"todo en uno\")\nEs la opción más integral. Un **diferencial Tipo B** monitorea fugas tanto en $AC$ como en $DC$. Al colocar un Tipo B en la línea dedicada a tu cargador, la protección es total y no requerís agregar módulos adicionales para corrientes continuas.",
      "### Opción 2: Un [diferencial Tipo A](/blog/post/disyuntor-diferencial-tipo-a/) + Protector RDC-DD (6 mA DC)\nMuchos cargadores de pared modernos (*Wallboxes*) ya vienen con un sensor interno llamado **RDC-DD** (*Residual Direct Current Detecting Device*), capaz de detectar fugas en continua a partir de $6\\text{ mA}$ y cortar el paso.\n\nSi tu cargador ya integra esta protección contra corriente continua, podés instalar en el tablero un **diferencial Tipo A**, lo cual resulta una opción más económica sin perder la seguridad reglamentaria.",
      "---",
      "## Recomendaciones clave para la instalación en Uruguay",
      "1. **Línea dedicada e independiente:** El punto de carga nunca debe colgarse de un circuito existente de la casa. Debe salir una línea independiente desde el tablero general, con su propio interruptor termomagnético (llave térmica) y su diferencial correspondiente.\n2. **Consultar la ficha del cargador:** Antes de comprar el diferencial, revisá si el *Wallbox* especifica que ya cuenta con protección de $6\\text{ mA DC}$ integrada. Esto te dirá inmediatamente si necesitás un Tipo B o si podés optar por un Tipo A.\n3. **Puesta a tierra impecable:** Ningún diferencial funciona al 100% si la descarga no tiene un camino eficiente para drenar. Asegurate de que la jabalina de tierra y la continuidad del cable de protección estén en regla.\n4. **Instalación profesional:** En Uruguay, la normativa de UTE y la reglamentación técnica exigen que estas instalaciones sean ejecutadas y supervisadas por personal autorizado.",
      "---",
      "## Resumen rápido",
      "* **No usés un diferencial común (Tipo AC)** para el circuito del cargador.\n* Si el cargador **no** incluye protección interna contra $DC$ $\\rightarrow$ **Instalá un [Diferencial Tipo B](/blog/post/disyuntor-diferencial-tipo-b/)**.\n* Si el cargador **sí** incluye sensor $6\\text{ mA DC}$ (RDC-DD) $\\rightarrow$ **Podés instalar un [Diferencial Tipo A](/blog/post/disyuntor-diferencial-tipo-a/)**.",
      "---",
      "### También te puede interesar",
      "- [Disyuntor diferencial Tipo B: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-b/)\n- [Disyuntor diferencial Tipo A: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-a/)\n- [Disyuntor diferencial Tipo AC: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-ac/)\n- [El mito del diferencial solo: por qué la toma a tierra es indispensable](/blog/post/el-mito-del-diferencial-solo/)"
    ]
  },
  {
    "id": "disyuntor-diferencial-tipo-ac",
    "title": "Disyuntor diferencial Tipo AC: ¿Qué es y cuándo usarlo?",
    "date": "21/07/2026",
    "excerpt": "Características, funcionamiento y limitaciones del diferencial Tipo AC en instalaciones residenciales tradicionales frente a electrodomésticos modernos.",
    "body": [
      ...
      "---",
      "## ¿Cuándo usar un diferencial Tipo AC?",
      ...
      "### Usos indicados:\n1. **Circuitos de iluminación tradicional:** Lámparas incandescentes, halógenas o tubos con balasto electromagnético.\n2. **Tomas de uso general (TUG) convencionales:** Para conectar electrodomésticos simples como estufas de cuarzo o alambre, planchas de ropa, tostadoras y hervidores de agua sin plaqueta electrónica.\n3. **Motores de inducción directos:** Bombas de agua pequeñas o motores sin variador de frecuencia ni electrónica de potencia.",
      "---",
      "## Limitaciones: ¿Por qué ya no sirve para todo?",
      ...
      "---",
      "## Resumen",
      "* **Ideal para:** Cargas residenciales clásicas y circuitos sencillos sin electrónica pesada.\n* **No apto para:** Equipos con tecnología *Inverter*, variadores de velocidad, informática avanzada ni cargadores de vehículos eléctricos.",
      "---",
      "### También te puede interesar",
      "- [Disyuntor diferencial Tipo A: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-a/)\n- [Disyuntor diferencial Tipo B: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-b/)\n- [¿Qué diferencial preciso para cargar mi auto eléctrico en Uruguay?](/blog/post/diferencial-auto-electrico-uruguay/)"
    ]
  },
  {
    "id": "disyuntor-diferencial-tipo-a",
    "title": "Disyuntor diferencial Tipo A: ¿Qué es y cuándo usarlo?",
    "date": "21/07/2026",
    "excerpt": "Por qué el diferencial Tipo A es el estándar recomendado para proteger hogares modernos con tecnología Inverter, iluminación LED y electrónica.",
    "body": [
      ...
      "---",
      "## ¿Cuándo usar un diferencial Tipo A?",
      "Es la opción adecuada para proteger circuitos que alimentan electrodomésticos con electrónica de potencia integrada.",
      "### Usos principales:\n1. **Electrodomésticos con tecnología *Inverter*:** Lavarropas, heladeras, lavavajillas y aires acondicionados modernos.\n2. **Circuitos de computación y electrónica:** Tableros que alimentan servidores, computadoras de escritorio, UPS y sistemas de entretenimiento.\n3. **Iluminación LED masiva:** Instalaciones con gran cantidad de drivers y fuentes electrónicas.\n4. **Cargadores de autos eléctricos con protección $DC$ integrada:** Si el cargador (*Wallbox*) cuenta internamente con un detector RDC-DD ($6\\text{ mA DC}$), la normativa permite proteger el circuito con un diferencial Tipo A.",
      "---",
      "## Ventajas frente al Tipo AC",
      "* **Mayor seguridad en viviendas modernas:** Previene la falta de disparo (\"cegación\") causada por componentes electrónicos.\n* **Continuidad de servicio:** Es menos susceptible a disparos intempestivos provocados por pequeños armónicos o transitorios de la red.\n* **Versatilidad:** Cumple con todas las funciones del Tipo AC y agrega protección para cargas pulsantes.",
      "---",
      "## Resumen",
      "* **Ideal para:** Viviendas actuales, oficinas, circuitos con electrónica, tecnología *Inverter* y puntos de carga de autos eléctricos con sensor $6\\text{ mA DC}$.\n* **Protección:** Detecta fugas alternas ($AC$) y continuas pulsantes.",
      "---",
      "### También te puede interesar",
      "- [Disyuntor diferencial Tipo B: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-b/)\n- [Disyuntor diferencial Tipo AC: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-ac/)\n- [¿Qué diferencial preciso para cargar mi auto eléctrico en Uruguay?](/blog/post/diferencial-auto-electrico-uruguay/)"
    ]
  ...
  {
    "id": "disyuntor-diferencial-tipo-b",
    "title": "Disyuntor diferencial Tipo B: ¿Qué es y cuándo usarlo?",
    "date": "21/07/2026",
    "excerpt": "El nivel de protección más alto frente a corrientes continuas puras (DC) y altas frecuencias. Aplicaciones en autos eléctricos, paneles solares e industria.",
    "body": [
      ...
      "<img src=\"/images/blog/tipos-diferenciales-comparativa.jpg\" alt=\"Comparativa de Disyuntores Diferenciales: Tipo AC, Tipo A y Tipo B\" style=\"border-radius:12px; margin:20px 0; width:100%; max-height:450px; object-fit:cover;\">",
      "---",
      "## ¿Qué es un diferencial Tipo B?",
      "Un diferencial **Tipo B** es un protector \"todoterreno\" capaz de detectar fugas de corriente en:\n* Corriente alterna senoidal ($AC$).\n* Corriente continua pulsante.\n* **Corriente continua lisa o pura ($DC$)**.\n\nAdemás, está capacitado para evaluar corrientes de fuga a frecuencias elevadas (hasta varios kilohertzios). Para lograr esto, incluye una electrónica interna sofisticada que analiza constantemente la forma de la onda, garantizando la desconexión del circuito sin importar el tipo de falla.",
      "---",
      "## ¿Cuándo usar un diferencial Tipo B?",
      ...
      "### Principales aplicaciones:\n1. **Cargadores de vehículos eléctricos (*Wallbox*):** Cuando el cargador no cuenta con un sensor interno de fugas en continua (RDC-DD de $6\\text{ mA}$), la norma exige instalar un diferencial Tipo B para evitar riesgos por fugas en $DC$.\n2. **Sistemas fotovoltaicos (Paneles solares):** En las líneas de conexión de inversores solares que carecen de aislamiento galvánico (inversores sin transformador).\n3. **Variadores de frecuencia industriales:** Ascensores, puentes grúa, bombas industriales y maquinaria con control preciso de velocidad.\n4. **Equipos médicos y centros de cómputo críticos:** Centros de diagnóstico, tomógrafos y UPS industriales trifásicas.",
      "---",
      "## Por qué es decisivo en la movilidad eléctrica",
      ...
      "---",
      "## Resumen",
      "* **Ideal para:** Puntos de carga de autos eléctricos sin filtro interno $DC$, energía solar, variadores de frecuencia y entornos industriales.\n* **Protección:** Cobertura total ($AC$, pulsante, altas frecuencias y $DC$ pura).",
      "---",
      "### También te puede interesar",
      "- [Disyuntor diferencial Tipo A: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-a/)\n- [Disyuntor diferencial Tipo AC: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-ac/)\n- [¿Qué diferencial preciso para cargar mi auto eléctrico en Uruguay?](/blog/post/diferencial-auto-electrico-uruguay/)"
    ]
  ...
  {
    "id": "el-mito-del-diferencial-solo",
    "title": "El mito del diferencial solo: por qué la toma a tierra es indispensable en una instalación eléctrica",
    "date": "21/07/2026",
    "excerpt": "Por qué fiar la seguridad eléctrica únicamente al interruptor diferencial es un grave error y cómo la puesta a tierra (PE) garantiza una verdadera protección preventiva.",
    "body": [
      "# El mito del diferencial solo: por qué la toma a tierra es indispensable en una instalación eléctrica",
      ...
      "---",
      "## ¿Cómo detecta una falla un interruptor diferencial?",
      ...
      "* **Funcionamiento normal:** I_fase = I_neutro. El diferencial permanece cerrado y la energía fluye normalmente.\n* **Fuga de corriente:** I_fase ≠ I_neutro. Cuando existe una diferencia de intensidad (típicamente a partir de 30 mA en instalaciones residenciales), el diferencial se dispara en cuestión de 20 a 40 ms para cortar el suministro.",
      ...
      "Si **no existe conexión a tierra** (o está interrumpida):\n1. La corriente no tiene un camino hacia dónde drenar.\n2. Como la corriente de entrada sigue siendo igual a la de salida en el circuito principal, **el diferencial no detecta ninguna anomalía** y no se dispara.\n3. El agua y la grifería quedan energizadas a la tensión de la red (230 V) esperando a que alguien las toque.",
      "---",
      "## Los 4 escenarios reales: ¿qué pasa cuando la falla entra en contacto con las personas?",
      ...
      "### 1. Contacto directo descalzo (sin tierra en la vivienda)\nSi una persona sale de la ducha o viene de hacer actividad física, la resistencia eléctrica de su cuerpo baja a unos 1000 Ω debido a la humedad y el sudor. Si toca un grifo energizado a 230 V estando descalza:\n\n> **Intensidad = 230 V / 1000 Ω = 230 mA**\n\n* **Resultado:** El diferencial se disparará (al superar los 30 mA), pero la persona habrá recibido una descarga de 230 mA. Teniendo en cuenta que corrientes superiores a 30 mA ya conllevan riesgo vital o fibrilación ventricular, **el diferencial saltó, pero la persona actuó como el \"conductor de prueba\" para que lo hiciera.**",
      "### 2. Contacto con calzado aislante (sandalias)\nAl usar sandalias, el calzado aísla temporalmente el cuerpo del suelo, por lo que el diferencial no se entera de la presencia de tensión al tocar el grifo. Sin embargo, al abrir la llave y recibir el agua energizada, el agua con sales disueltas rompe el aislamiento del calzado en milisegundos. La resistencia corporal cae aún más y la descarga vuelve a circular a través del cuerpo antes de que el diferencial llegue a cortar.",
      "### 3. Instalación con una tierra deficiente (alta resistencia)\nSi la instalación tiene una toma a tierra con resistencia muy elevada (por ejemplo, mayor a 100 Ω), la corriente de fuga buscará el camino de menor resistencia. Si la resistencia del cuerpo humano es menor que la de la propia puesta a tierra defectuosa, gran parte de la descarga volverá a circular por la persona.",
      "### 4. La combinación correcta: Buena tierra (≤ 10 Ω) + Diferencial\nEn una instalación con una puesta a tierra adecuada:\n1. En el instante exacto en que la resistencia del termo se rompe y deriva tensión a la masa o al agua, **la corriente drena inmediatamente a tierra** (230 V / 10 Ω = 23 A).\n2. El diferencial detecta al instante que I_fase ≠ I_neutro y **se dispara de forma automática en 20 a 40 milisegundos**.\n3. **Nadie necesita tocar el grifo ni el electrodoméstico** para que la protección actúe. La instalación se desenergiza antes de que exista riesgo para cualquier usuario.",
      "---",
      "## Conclusión",
      "El interruptor diferencial y la puesta a tierra no son alternativas intercambiables, sino **componentes complementarios de un mismo sistema de seguridad**:\n\n* La **toma a tierra** proporciona el canal de drenaje preventivo ante fallas de aislamiento.\n* El **diferencial** detecta la fuga por ese canal y corta el suministro eléctrico.\n\nConfiar únicamente en el diferencial significa aceptar que el cuerpo humano sea el encargado de cerrar el circuito para que la protección reaccione. La verdadera seguridad eléctrica se logra únicamente mediante la **doble protección**.",
      "---",
      "### También te puede interesar",
      "- [El mito del cable \"inútil\": Por qué el conductor de tierra es el héroe silencioso](/blog/post/el-mito-del-cable-inutil/)\n- [¿Qué diferencial preciso para cargar mi auto eléctrico en Uruguay?](/blog/post/diferencial-auto-electrico-uruguay/)\n- [Disyuntor diferencial Tipo B: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-b/)"
    ]
  },
  {
    "id": "el-mito-del-cable-inutil",
    "title": "El mito del cable \"inútil\": Por qué el conductor de tierra es el verdadero héroe silencioso de tu hogar",
    "date": "21/07/2026",
    "excerpt": "Ignorar o desconectar el cable verde/amarillo pone en riesgo tu hogar. Análisis de la física del camino paralelo y protección activa vs pasiva.",
    "body": [
      "# El mito del cable \"inútil\": Por qué el conductor de tierra es el verdadero héroe silencioso de tu hogar",
      ...
      "---",
      "## ¿Cuál es la función real del cable de tierra?",
      ...
      "### La física del camino paralelo\nLa corriente eléctrica siempre busca cerrar circuito de regreso a la fuente (el transformador de distribución) a través del camino que le ofrezca **menor impedancia**.\n\n* **Resistencia del cuerpo humano húmedo:** Cerca de 1000 Ω (o menos según el grado de humedad).\n* **Resistencia de un circuito de tierra bien dimensionado:** Habitualmente menor a 10 Ω.\n\nSi la fase entra en contacto con la carcasa metálica de una lavadora:\n\n1. **Sin cable de tierra:** La masa metálica queda a 230 V respecto al suelo. La carga se queda ahí \"atrapada\" hasta que una persona toca la carcasa y ofrece el único camino posible hacia el suelo.\n2. **Con cable de tierra:** El cable verde/amarillo uniendo la carcasa a la jabalina o pica de tierra ofrece una resistencia de apenas unos pocos ohms. La corriente de fuga drena **de inmediato** de forma masiva hacia la tierra.",
      "---",
      "## La diferencia entre protección activa y protección pasiva",
      ...
      "* **El diferencial es una protección reactiva:** Necesita que *ocurra* una fuga de corriente para medir la diferencia entre fase y neutro y abrir el circuito.\n* **El cable de tierra es la ruta de escape previa:** Es el medio físico que permite que esa fuga ocurra *inmediatamente en el equipo*, antes de que el usuario intervenga.",
      ...
      "---",
      "## Qué pasa cuando el cable de tierra está mal instalado o interrumpido",
      ...
      "1. **Falta de continuidad en el circuito:** Conectar el cable de tierra en los tomacorrientes pero dejarlo desconectado en las cajas de paso o en la barra principal del tablero. Esto genera una \"falsa sensación de seguridad\".\n2. **Resistencia de jabalina elevada:** Picas de tierra sulfatadas, flojas o clavadas en terrenos secos con alta resistividad sin tratamiento. Si la resistencia a tierra sube por encima de los valores normativos, parte de la corriente de falla buscará otros caminos (como el usuario).\n3. **El \"puente\" peligroso entre Neutro y Tierra (PEN improvisado):** Unir el neutro al borne de tierra en un tomacorriente dentro de una instalación monofásica residencial. Esta práctica es extremadamente peligrosa: si el neutro de la red se corta aguas arriba, todas las carcasas metálicas conectadas a ese tomacorriente quedarán energizadas a la tensión de fase.",
      "---",
      "## Conclusión",
  ...
  },
  {
    ...
    "body": [
      ...
      "## Los tipos de diferenciales en el mercado (de un vistazo)",
      "En el mundo de las instalaciones eléctricas existen varios tipos de diferenciales según la forma de onda de la corriente que son capaces de supervisar:",
      "* **Tipo AC:** El estándar residencial básico, optimizado exclusivamente para corrientes alternas sinusoidales puras.\n* **Tipo A:** Diseñado para detectar tanto corrientes alternas como corrientes pulsantes con componentes continuas.\n* **Tipo B:** La protección más completa, capaz de detectar fugas en corriente alterna, corrientes pulsantes y **corriente continua pura ($DC$)**.",
      "---",
      "## ¿Cuál es el diferencial que exige la carga de un auto eléctrico?",
      "Para estar cubierto ante las fugas en continua que generan los cargadores de vehículos eléctricos, tenés dos opciones principales aprobadas por la normativa técnica:",
      "### Opción 1: Un diferencial Tipo B (La solución \"todo en uno\")\nEs la opción más integral. Un **diferencial Tipo B** monitorea fugas tanto en $AC$ como en $DC$. Al colocar un Tipo B en la línea dedicada a tu cargador, la protección es total y no requerís agregar módulos adicionales para corrientes continuas.",
      "### Opción 2: Un diferencial Tipo A + Protector RDC-DD (6 mA DC)\nMuchos cargadores de pared modernos (*Wallboxes*) ya vienen con un sensor interno llamado **RDC-DD** (*Residual Direct Current Detecting Device*), capaz de detectar fugas en continua a partir de $6\\text{ mA}$ y cortar el paso.\n\nSi tu cargador ya integra esta protección contra corriente continua, podés instalar en el tablero un **diferencial Tipo A**, lo cual resulta una opción más económica sin perder la seguridad reglamentaria.",
      "---",
      "## Recomendaciones clave para la instalación en Uruguay",
      "1. **Línea dedicada e independiente:** El punto de carga nunca debe colgarse de un circuito existente de la casa. Debe salir una línea independiente desde el tablero general, con su propio interruptor termomagnético (llave térmica) y su diferencial correspondiente.\n2. **Consultar la ficha del cargador:** Antes de comprar el diferencial, revisá si el *Wallbox* especifica que ya cuenta con protección de $6\\text{ mA DC}$ integrada. Esto te dirá inmediatamente si necesitás un Tipo B o si podés optar por un Tipo A.\n3. **Puesta a tierra impecable:** Ningún diferencial funciona al 100% si la descarga no tiene un camino eficiente para drenar. Asegurate de que la jabalina de tierra y la continuidad del cable de protección estén en regla.\n4. **Instalación profesional:** En Uruguay, la normativa de UTE y la reglamentación técnica exigen que estas instalaciones sean ejecutadas y supervisadas por personal autorizado.",
      "---",
      "## Resumen rápido",
      "* **No usés un diferencial común (Tipo AC)** para el circuito del cargador.\n* Si el cargador **no** incluye protección interna contra $DC$ $\\rightarrow$ **Instalá un Diferencial Tipo B**.\n* Si el cargador **sí** incluye sensor $6\\text{ mA DC}$ (RDC-DD) $\\rightarrow$ **Podés instalar un Diferencial Tipo A**."
    ]
  },
  {
    "id": "disyuntor-diferencial-tipo-ac",
