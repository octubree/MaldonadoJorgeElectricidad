...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    "body": [
      ...
      "---",
      "## Resumen",
      "* **Ideal para:** Viviendas actuales, oficinas, circuitos con electrónica, tecnología *Inverter* y puntos de carga de autos eléctricos con sensor 6 mA DC.\n* **Protección:** Detecta fugas alternas (AC) y continuas pulsantes.",
      "---",
      "### También te puede interesar",
      "- [Disyuntor diferencial Tipo B: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-b/)\n- [Disyuntor diferencial Tipo AC: ¿Qué es y cuándo usarlo?](/blog/post/disyuntor-diferencial-tipo-ac/)\n- [¿Qué diferencial preciso para cargar mi auto eléctrico en Uruguay?](/blog/post/diferencial-auto-electrico-uruguay/)"
    ]
  ...
  },
  {
    ...
    "body": [
      ...
      "---",
      "## Resumen rápido",
      "* **No usés un diferencial común (Tipo AC)** para el circuito del cargador.\n* Si el cargador **no** incluye protección interna contra DC → **Instalá un Diferencial Tipo B**.\n* Si el cargador **sí** incluye sensor 6 mA DC (RDC-DD) → **Podés instalar un Diferencial Tipo A**."
    ]
  },
  {
    "id": "disyuntor-diferencial-tipo-ac",
